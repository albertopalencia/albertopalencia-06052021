...
// ***********************************************************************
// <copyright file="ace.sidebar-scroll-1.js" company="WebApp">
...
ace.sidebar_scrollable = function($ , options) {
	...
	var scrollbars = ace.helper.sidebar_scroll = {
		...
		initiate: function(on_page_load) {
			/// <summary>
			/// </summary>
			/// <param name="on_page_load">The on page load.</param>
		...
		prehide: function(height_change) {
			/// <summary>
			/// </summary>
			/// <param name="height_change">The height change.</param>
	...
	$(document).on('settings.ace.scroll', function(ev, event_name, event_val){
		...
		/// <param name="event_val">The event value.</param>
