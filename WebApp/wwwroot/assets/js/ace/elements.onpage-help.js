...
// ***********************************************************************
// <copyright file="elements.onpage-help.js" company="WebApp">
...
window.Onpage_Help = function(options) {
	...
	function launch_help_modal(section_name, save_to_list) {
		/// <summary>
		/// Launches the help modal.
		/// </summary>
		/// <param name="section_name">Name of the section.</param>
		/// <param name="save_to_list">The save to list.</param>
		if(help_modal == null) {
			...
			if(typeof _.settings.code_highlight === 'function') {
				...
				try {
					Rainbow.color(result, language, function(highlighted_code) {
						/// <summary>
						/// </summary>
						/// <param name="highlighted_code">The highlighted code.</param>
