...
// ***********************************************************************
// <copyright file="elements.fileinput.js" company="WebApp">
...
(function($ , undefined) {
	...
	var Ace_File_Input = function(element , settings) {
		...
		.on('change.ace_inner_call', function(e , ace_inner_call){
			...
			/// <param name="ace_inner_call">The ace inner call.</param>
	...
	Ace_File_Input.prototype.enable_reset = function(can_reset) {
		/// <summary>
		/// </summary>
		/// <param name="can_reset">The can reset.</param>
	...
	Ace_File_Input.prototype.loading = function(is_loading) {
		/// <summary>
		/// </summary>
		/// <param name="is_loading">The is loading.</param>
		if(is_loading === false) {
	...
	var processFiles = function(file_list, dropped) {
		/// <summary>
		/// </summary>
		/// <param name="file_list">The file list.</param>
